...
public class Main {
    public static void main(String[] args) {
        ...
        famousPeople.add(new Person("Fernando", "Alvarez de Toledo y Pimentel", 14));
        ...
        famousPeople.add(new Person("Otto Eduard Leopold", "von Bismarck Schonhausen", 18));

        famousPeople.removeIf(Person -> Person.getAge() < 18);
